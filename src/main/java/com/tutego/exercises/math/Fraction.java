package com.tutego.exercises.math;
...
public final class Fraction extends Number implements Comparable<Fraction> {
  ...
  public Fraction( int numerator, int denominator ) {
    if ( denominator == 0 )
      throw new ArithmeticException( "denominator of a fraction can not be 0" );
    ...
    int gcd = gcd( numerator, denominator );  // might be 1, but divide anyway
